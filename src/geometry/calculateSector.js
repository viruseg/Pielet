...
/**
 * Путь SVG-глифа шеврона индикатора сабменю — залитый треугольник, направленный
 * радиально наружу (вершина «вправо», path замыкается «Z» — по сути тот же
 * визуальный глиф, что и текстовый '›'), но без метрического сдвига шрифта:
 * глиф симметричен относительно горизонтальной центральной линии бокса (в
 * viewBox 0 0 24 24 это y = 12). Благодаря этой симметрии визуальный центр глифа
 * лежит на одной горизонтали с центром бокса, поэтому шевроны на лучах mid=0 и
 * mid=π (после поворота на 180°) оказываются точно на одной линии — текстовый
 * '›' смещал их визуально.
 * @type {string}
 */
export const SUBMENU_CHEVRON_PATH = 'M7 5 L17 12 L7 19 Z';
